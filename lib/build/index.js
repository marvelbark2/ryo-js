            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.allSettled(pages
                            ...
                            var pageName, compPackage;
                            return __generator(this, function (_a) {
                                var _b;
                                pageName = (0, page_1.getPageName)(page);
                                compPackage = (0, fs_1.readFileSync)(page).toString("utf-8");
                                console.log({
                                    page: page
                                });
                                // @ts-ignore
                                (_b = page, Promise.resolve().then(function () { return __importStar(require(_b)); })).then(function (Component) {
...
function publishReport() {
    var data = JSON.stringify(buildReport, null, 2);
    console.log("🕧 Building pages report");
    var jsonReportPath = (0, path_1.join)(process.cwd(), ".ssr/output/build-report.json");
    (0, fs_1.writeFileSync)(jsonReportPath, data, { flag: 'wx' });
}
function build() {
    return __awaiter(this, void 0, void 0, function () {
        var e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5: return [2 /*return*/, console.log("✅ Done building")];
