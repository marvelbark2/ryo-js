...
function generateData(filePath, pageName) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, build(__assign({ bundle: true, minify: true, treeShaking: true, entryPoints: [filePath], target: "node15", platform: 'node', outfile: join(".ssr/output/server/data", "".concat(pageName, ".data.js")) }, watchOnDev))];
                case 1:
                    building = _a.sent();
...
export function createStaticFile(Component, filePath, pageName, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    outdir = (options === null || options === void 0 ? void 0 : options.outdir) || join(".ssr/output/static");
                    if (!(options === null || options === void 0 ? void 0 : options.bundle)) return [3 /*break*/, 2];
                    return [4 /*yield*/, generateClientBundle({ filePath: filePath, outdir: outdir, pageName: pageName })];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
                ...
                case 6:
                    ...
                    _a.label = 7;
                case 7:
                    Element_1 = createElement(App, { data: data !== null && data !== void 0 ? data : null });
                    writeFileSync(join(outdir, (options === null || options === void 0 ? void 0 : options.fileName) || "".concat(pageName, ".html")), "<!DOCTYPE html>\n        <head>\n          <meta charset=\"UTF-8\">\n          <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n          <link rel=\"preload\" href=\"/styles.css\" as=\"style\" onload=\"this.onload=null;this.rel='stylesheet'\">\n          <noscript><link rel=\"stylesheet\" href=\"/styles.css\"></noscript>    \n          <script src=\"/framework-system.js\" defer></script>\n\n        </head>\n        <body>\n          <div id=\"root\">".concat(render(Element_1), "</div>\n          ").concat(Component.data ? "<script src=\"/".concat(pageName, ".data.js\" ></script>") : '', "\n          <script src=\"/").concat(pageName, ".bundle.js\" defer></script>\n          \n        </body>"));
                    return [3 /*break*/, 9];
                case 8:
                    error_1 = _a.sent();
