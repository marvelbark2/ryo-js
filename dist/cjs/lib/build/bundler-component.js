        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2: return [4 /*yield*/, _d.apply(void 0, [__assign.apply(void 0, [__assign.apply(void 0, [__assign.apply(void 0, _e.concat([(_f.stdin = (_g.contents = _h.sent(),
                                        ...
                                        _g), _f.plugins = [(0, esbuild_plugin_gzip_1.default)({ gzip: true })], _f.target = "esnext", _f.outfile = (0, path_1.join)(".ssr/output/static", "".concat(pageName, ".bundle.js")), _f.keepNames = process.env.NODE_ENV === "development", _f.metafile = true, _f)])), global_1.watchOnDev]), { external: __spreadArray(__spreadArray(__spreadArray([], Object.keys(pkg.dependencies || {}), true), Object.keys(pkg.peerDependencies || {}), true), Object.keys(pkg.devDependencies || {}), true).filter(function (x) { return !x.includes('ryo.js'); }) }])])];
                case 3:
                    result = _h.sent();
