...
export default function server() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof data === 'function') {
                ...
                if (cachedData.has(pageName)) {
                    ...
                    const dataCall = (yield data.runner());
                    const template = `function getData(){return '${JSON.stringify(dataCall)}';}`;
                    if (!res.aborted) {
                        gzip(template, function (_, result) {
                            if (data.invalidate)
                    ...
                    if (data.invalidate) {
                        const token = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                            try {
                                const currentValue = cachedData.get(pageName);
                                const dataCall = (yield data.runner(() => clearInterval(token)));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (method.includes(method)) {
                    ...
                    const data = api.constructor.name === 'AsyncFunction' ? yield dataCall : dataCall;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isDataJs) {
                ...
                if (buildReport[pageName]) {
                    return yield renderData(res, subPath);
                }
                else {
    ...
    function render(res, req, path = req.getUrl(), params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (exts.length > 1) {
                return yield renderStatic(res, exts, path);
            }
            else {
                try {
                    ...
                    if (pageName) {
                        ...
                        if (fileExists) {
                            ...
                            return yield renderAPI(res, req, pageName);
                        }
                    }
                    else {
    ...
    function renderServer(res, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                 ...
                 */
                const defaultComponent = component.default.constructor.name === 'AsyncFunction' ? yield component.default() : component.default();
                const Element = createElement(() => defaultComponent, null);
                res.writeHeader("Content-Type", "text/html");
                const html = preactRender(Element);
                const clientBundle = yield generateClientBundle({ filePath: componentPath, data: null });
    ...
    Object.keys(buildReport)
        ...
        app.any(pageName, (res, req) => __awaiter(this, void 0, void 0, function* () {
            const path = req.getUrl();
            const exts = path.split(".");
            if (exts.length > 1) {
                ...
                if (isServer) {
                    return yield renderServer(res, pageServerName);
                }
    ...
    app.any("/*", (res, req) => __awaiter(this, void 0, void 0, function* () {
        const path = req.getUrl();
        const exts = path.split(".");
        if (exts.length > 1) {
            return renderStatic(res, exts, path);
